...
| `REST_COUNTRIES_API_KEY` | *(tu API key de https://restcountries.com/sign-up)* |

> **REST Countries:** la API pública v3 ya no devuelve datos. Configura `REST_COUNTRIES_API_KEY` con tu key v5.
